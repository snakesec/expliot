...
class BlePeripheral(Peripheral):
    ...
    def enable_notify(self, delegate, handle, write_response=False):
        r"""Enables notification for a specific characteristic on a peripheral.
...
class BleNotifyDelegate(DefaultDelegate):
    ...
    def __init__(self, callback):
        """Initialize with super's init and set custom callback.

        This is implemented to keep a tab on the no. of times handleNotification
        is called.
