...
class SimpleMqttClient:
    ...
    def sub(topics, **kwargs):
        ...
        For details on arguments, please refer paho/mqtt/subscribe.py
        in paho-mqtt project (https://pypi.org/project/paho-mqtt/).
    ...
    def pub(topic, **kwargs):
        ...
        For details on arguments, please refer paho/mqtt/publish.py
        in paho-mqtt project (https://pypi.org/project/paho-mqtt/).
    ...
    def _on_connauth(client, userdata, flags, return_code):
        ...
        The arguments are passed by client object. Details of the
        arguments are documented in paho/mqtt/client.py
...
class MqttClient(Client):
    ...
    For more details on the functionality check,
    see https://github.com/eclipse/paho.mqtt.python
    """
    ...
    def __init__(
        ...
        """Wrapper on client method.

        Also initialises some new members.
    ...
    def on_connectcb(self, client, userdata, flags, retcode):
        ...
        It sets the member with connection return code and
        disconnects on error. Used by pub and sub plugins.
    ...
    def on_publishcb(self, client, userdata, mid):
        ...
        It disconnects the connection assuming the message has been published.
        Don't use this if you want to send
    ...
    def on_disconnectcb(self, client, userdata, retcode):
        ...
        It sets the member with disconnection
    ...
    def easy_config(
        ...
        It sets the username, password and default callbacks required by
        the pub sub plugins.
